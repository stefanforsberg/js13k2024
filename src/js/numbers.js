export class Number {
    ...
    update(deltaTime) {
        ...
        if (this.x > (this.state.width - this.width) && this.dx > 0 && this.bounces > 0) {
            this.bounces--;
            this.dx = -1 * this.dx;
        }
        if (this.y > (this.state.height - this.height) && this.dy > 0 && this.bounces > 0) {
            this.bounces--;
            this.dy = -1 * this.dy;
        }
        ...
        if (this.x < -150 || this.y < -150 || this.x > this.state.width + 150 || this.y > this.state.height + 150) {
            this.reset();
        }
    }
